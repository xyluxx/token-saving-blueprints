...
| Existing local GPU runtime | Keep the current route as baseline; inspect existing LM Studio/Ollama/other endpoint | [Runtime-neutral local GPU routing](local-gpu-routing.md) only after specification, memory, tools and quality gates |
